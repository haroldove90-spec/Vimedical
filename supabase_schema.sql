...
CREATE TABLE IF NOT EXISTS wounds (
  ...
  oxygenation NUMERIC,
  glycemia_fasting NUMERIC,
  glycemia_postprandial NUMERIC,
  width NUMERIC,
  length NUMERIC,
  depth NUMERIC,
  tunneling TEXT,
  ...
  abi_arm NUMERIC,
  abi_left_toe NUMERIC,
  abi_left_pedal NUMERIC,
  abi_left_post_tibial NUMERIC,
  abi_right_toe NUMERIC,
  abi_right_pedal NUMERIC,
  abi_right_post_tibial NUMERIC,
  prognosis TEXT,
...
BEGIN
  ...
  VALUES (
    ...
    new.email, 
    COALESCE(new.raw_user_meta_data->>'role', 'Enfermero')
  );
  RETURN new;
END;
